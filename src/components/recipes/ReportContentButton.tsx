  ...
  if (isReported) {
    return (
      <div className="relative">
        <button
          disabled
          className="flex items-center px-2 py-1 text-xs font-medium rounded-md bg-emerald-50 text-emerald-700 border-2 border-emerald-300 transition-all duration-200"
        >
  ...
  return (
    <div className="relative">
      <button
        ...
        className="group flex items-center px-2 py-1 text-xs font-medium rounded-md border-2 border-red-200 bg-white text-red-600 hover:bg-red-50 hover:border-red-300 hover:text-red-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        title="Report inappropriate content"
      >
        <svg 
          className="w-3 h-3 mr-1 transition-transform duration-200 group-hover:scale-110" 
          fill="none" 
          stroke="currentColor" 
          viewBox="0 0 24 24" 
        ...
        {isReporting ? (
          <span className="flex items-center">
            <svg className="animate-spin -ml-1 mr-1 h-2.5 w-2.5 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
